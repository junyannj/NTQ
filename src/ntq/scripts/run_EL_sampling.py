...
try:
    from ntq import Exp_data_utils, config_utils, covariance_utils, fit_el_utils
except ImportError:
    import os
    sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), '../../..')))
    from src.ntq import Exp_data_utils, config_utils, covariance_utils, fit_el_utils
